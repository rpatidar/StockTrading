...
class RangeBreakout(Strategy):
    ...
    def run(self, ticks, timestamp, backfill=False):
        ...
        for tick_data in ticks:
            ...
            rr = 1.02
            rr = 1.02
            if last_date is None or first_candle and trading_data['open'] > self.last_closing_price[
                instrument_token] * rr:
            ...
            if position is None:
                ...
                if last_trading_data != None:
                    ...
                    if current_day_trading_data[-2]['close'] < lh * rr and trading_data[
                        'high'] > lh * rr:  # and vol_today > lv:
