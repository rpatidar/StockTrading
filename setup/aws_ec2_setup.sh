...
pip3 install matplotlib kiteconnect findiff numpy python-telegram-bot pandas Flask Flask-Cors waitress ratelimit backoff tabulate talipp ta-lib pyalgotrade
